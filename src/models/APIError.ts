...
export interface APIError {
  ...
  errorCode?: string;
  /**
   * @description Category the error belongs to. The category should give an indication of the type of error you are
   * dealing with. Do not expect a finite set of possible categories, as they are subject to change.
   * Common values are:
