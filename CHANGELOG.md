...
* feat: update API version to 1.59.0 ([d39780704ed2c3aceed0e2b98a12ee44a188499f](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/d39780704ed2c3aceed0e2b98a12ee44a188499f))
* feat: update API version to 1.60.0 ([cca297f6c661ea5b2f236d350f25d1445ed2cd7b](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/cca297f6c661ea5b2f236d350f25d1445ed2cd7b))
* feat: update API version to 1.61.0 ([e6a8802183a1a1707a12f059ca3596d994dbb515](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/e6a8802183a1a1707a12f059ca3596d994dbb515))

# [1.12.0](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/compare/v1.11.0...v1.12.0) (2026-07-08)

### Features

* feat: update API version to 1.57.0 ([29ec02033702786388503fd5ed82ea17092f8dfd](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/29ec02033702786388503fd5ed82ea17092f8dfd))

# [1.11.0](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/compare/v1.10.0...v1.11.0) (2026-06-15)

### Features

* feat: update API version to 1.56.0 ([788a23926c175ef91f6df4543a96725dd917269b](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/788a23926c175ef91f6df4543a96725dd917269b))

# [1.10.0](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/compare/v1.9.0...v1.10.0) (2026-05-22)

### Features

* feat: update API version to 1.55.0 ([d2223ba54e8eaf058d855f69ee994972c58bc1a8](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/d2223ba54e8eaf058d855f69ee994972c58bc1a8))

# [1.9.0](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/compare/v1.8.0...v1.9.0) (2026-04-29)

### Features

* feat: update API version to 1.50.0 ([460b50da75f30545795c777d66a6324b86f38a3b](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/460b50da75f30545795c777d66a6324b86f38a3b))
...
* docs: update changelog for version 1.5.0 and adjust links ([af8f44f157bc13eb3199605ff6ff1f33991e5ab1](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/af8f44f157bc13eb3199605ff6ff1f33991e5ab1))

# [1.5.0](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/compare/v1.0.0...v1.5.0) (2025-12-09)

### Documentation

* docs: add changelog ([36bfba85db5ef41011b2a84b63114fd6f062c74d](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/36bfba85db5ef41011b2a84b63114fd6f062c74d))
...
* docs: update README to reflect api-version 1.40.0 ([c3310aeda373a0da996ef53bf1897afae88c0211](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/c3310aeda373a0da996ef53bf1897afae88c0211))
...
* feat: add support for paypal payment completion ([93ccff84ca975a6fbbad7cb0d301a794aebc19d0](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/93ccff84ca975a6fbbad7cb0d301a794aebc19d0))
* feat: adjust models and descriptions according to new api definition ([9bed29f5d517a84b0132f2fb7c4270441920f55e](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/9bed29f5d517a84b0132f2fb7c4270441920f55e))
* feat: enhance model documentation with examples and maxLength constraints ([d877937b771834ddb2db0011d6fa757c4bb4b176](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/d877937b771834ddb2db0011d6fa757c4bb4b176))
* feat: enhance payment interfaces with additional fields and descriptions ([61e4e21404cceff58cd1017c29f4c193d4c18175](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/61e4e21404cceff58cd1017c29f4c193d4c18175))
...
* feat: introduce PaymentProductId type and update related interfaces ([75b8fea51338e9a6e920f1c10c039f423fd36457](https://github.com/PAYONE-GmbH/PCP-server-nodeJS-SDK/commit/75b8fea51338e9a6e920f1c10c039f423fd36457))
